...
public class SRI extends Stack{


    private static Logger logger = Logger.getLogger(SRI.class);
    ...
    private void initSCTP(IpChannelType ipChannelType) throws Exception {
        System.out.println("\033[32m[*]\033[0mInitializing SCTP Stack ....");
        try {
    ...
    private void initM3UA() throws Exception {
        System.out.println("\033[32m[*]\033[0mInitializing M3UA Stack ....");
        try{
    ...
    private void initSCCP() throws Exception {
        System.out.println("\033[32m[*]\033[0mInitializing SCCP Stack ....");
    ...
    private void initTCAP() throws Exception {
        System.out.println("\033[32m[*]\033[0mInitializing TCAP Stack ....");
        try {
    ...
    private void initMAP() throws Exception {
        System.out.println("\033[32m[*]\033[0mInitializing MAP Stack ....");
    ...
    private void initiateSRI() throws MAPException {
        ...
        try {
            ...
            mapDialog.addSendRoutingInformationRequest(msisdn, null, null, InterrogationType.basicCall, false, null,
                    Gmsc, null, null, null, null, null, false, null, null, false, null, null, null, false, null, true, true, false, true,
    ...
    public void onDialogNotice(MAPDialog mapDialog, MAPNoticeProblemDiagnostic noticeProblemDiagnostic) {
        ...
        System.err.printf("onDialogNotice for DialogId=%d MAPNoticeProblemDiagnostic=%s ",
                mapDialog.getLocalDialogId(), noticeProblemDiagnostic);
    }
    ...
    public void onDialogProviderAbort(MAPDialog mapDialog, MAPAbortProviderReason abortProviderReason,
        ...
        System.err.printf("onDialogProviderAbort for DialogId=%d MAPAbortProviderReason=%s MAPAbortSource=%s MAPExtensionContainer=%s",
                mapDialog.getLocalDialogId(), abortProviderReason, abortSource, extensionContainer);
    }
    ...
    public void onDialogReject(MAPDialog mapDialog, MAPRefuseReason refuseReason,
        ...
        /*logger.error(String
                .format("onDialogReject for DialogId=%d MAPRefuseReason=%s MAPProviderError=%s ApplicationContextName=%s MAPExtensionContainer=%s",
                        ...
                        extensionContainer));*/
        System.err.printf("onDialogReject for DialogId=%d MAPRefuseReason=%s MAPProviderError=%s ApplicationContextName=%s MAPExtensionContainer=%s",
    ...
    public void onDialogTimeout(MAPDialog mapDialog) {
        ...
        System.err.printf("onDialogTimeout for DialogId=%d", mapDialog.getLocalDialogId());
    }
    ...
    public void onDialogUserAbort(MAPDialog mapDialog, MAPUserAbortChoice userReason,
        ...
        System.err.printf("onDialogUserAbort for DialogId=%d MAPUserAbortChoice=%s MAPExtensionContainer=%s",
                mapDialog.getLocalDialogId(), userReason, extensionContainer);
    }
    ...
    public void onErrorComponent(MAPDialog mapDialog, Long invokeId, MAPErrorMessage mapErrorMessage) {
        ...
        System.err.printf("onErrorComponent for Dialog=%d and invokeId=%d MAPErrorMessage=%s",
                mapDialog.getLocalDialogId(), invokeId, mapErrorMessage);
    }
    ...
    public void onInvokeTimeout(MAPDialog mapDialog, Long invokeId) {
        ...
        System.err.printf("onInvokeTimeout for Dialog=%d and invokeId=%d", mapDialog.getLocalDialogId(), invokeId);
    ...
    @Override
    //Could extract results if running tcpdump and capturing the traffic
    public void onSendRoutingInformationResponse(SendRoutingInformationResponse sendRoutingInformationResponse) {
        try{
            ...
            double Lat_cs = sendRoutingInformationResponse.getSubscriberInfo().getLocationInformation().getGeographicalInformation().getLatitude();
            double Long_cs = sendRoutingInformationResponse.getSubscriberInfo().getLocationInformation().getGeographicalInformation().getLongitude();
            ...
            if(Lat_cs==0 && Long_cs ==0){
                System.out.println("\033[32m[-]\033[0mNo Info returned for the parameters LAT and Long");
            }else{
                System.out.println("\033[32m[+]\033[0mGPS Location Information:\033[31mLAT "+Lat_cs +"\t"+"Long "+Long_cs);
            }

            if(sendRoutingInformationResponse.getSubscriberInfo().getLocationInformation().getCellGlobalIdOrServiceAreaIdOrLAI().toString().isEmpty()){
