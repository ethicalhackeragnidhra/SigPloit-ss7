...
def mode():
	...
	def simulation():
		print "\033[34m[*]\033[0mPlease run the corresposnding server side under the \033[33m'Testing/Server/Attacks/Location_Tracking'\033[0m directory on another machine"
