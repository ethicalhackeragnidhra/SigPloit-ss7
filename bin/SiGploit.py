...
def attacksMenu():
	...
	print "3) Documentation".rjust(19)
	print 
	...
	if choice == "0":
		...
		#Interception()
		print "\n\033[34m[*]\033[0mInterception will be updated in next minor release.."
		...
		print "\n\033[34m[*]\033[0mDocumentation will be updated in next major release.."
		print "\033[34m[*]\033[0mGoing back to SS7 Attacks Menu"
		time.sleep(2)
		attacksMenu()
	elif choice == "back":
		mainMenu()
