...
sri_path = os.path.join(os.getcwd(),'SigPloit/SS7/Tracking/SRI')
srism_path = os.path.join(os.getcwd(),'SigPloit/SS7/Tracking/SRISM')
psi_path = os.path.join(os.getcwd(),'SigPloit/SS7/Tracking/PSI')
ati_path = os.path.join(os.getcwd(),'SigPloit/SS7/Tracking/ATI')
srigprs_path = os.path.join(os.getcwd(),'SigPloit/SS7/Tracking/SRIGPRS')
