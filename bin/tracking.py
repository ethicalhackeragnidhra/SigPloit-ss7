...
srigprs_path = os.path.join(home_dir,'SigPloit/SS7/Tracking/SRIGPRS')
...
def sri():
	...
	if jar_file not in os.listdir(sri_path):
		print '\033[31m[-]Error:\033[0m This attack is not found..Check for Updates'
		time.sleep(1)
...
def srigprs():
	...
	if jar_file not in os.listdir(srigprs_path):
		print '\033[31m[-]Error:\033[0m This attack is not found..Check for Updates'
		time.sleep(1)
		print '\033[34m[*]\033[0mGoing back to Location Tracking Attacks Menu'
		time.sleep(1.5)
