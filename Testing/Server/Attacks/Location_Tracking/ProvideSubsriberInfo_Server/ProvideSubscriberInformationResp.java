...
public class ProvideSubscriberInformationResp extends PSILowLevelServer {
	...
	//Add the GT of the called local VLR(target) in the string field
    ...
    public void onProvideSubscriberInfoRequest(ProvideSubscriberInfoRequest provideSubscriberInfoRequest) {
        try{
            ...
            //Creating Subscriber Information, more information could be added under the locationInfromation variable
            LocationInformation locationInformation = this.mapProvider.getMAPParameterFactory()
                    .createLocationInformation(30,null,null,null,null,null,null,null,null,false,false,null,null);

	    //Add a 15 digits IMEI number in the string parameter
            IMEI imei = this.mapProvider.getMAPParameterFactory().createIMEI("");
