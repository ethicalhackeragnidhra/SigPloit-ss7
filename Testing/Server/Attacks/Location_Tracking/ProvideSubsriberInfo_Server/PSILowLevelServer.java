...
public abstract class PSILowLevelServer implements MAPDialogListener, MAPServiceMobilityListener {
    ...
    public void init() {
        try {
            ...
            InputStream inStreamLog4j = PSILowLevelServer.class.getResourceAsStream("log4j.properties");
