...
public class AnyTimeInterrogationResp extends ATILowLevelServer {

    private static Logger logger = Logger.getLogger(AnyTimeInterrogationResp.class);
    ...
    public AnyTimeInterrogationResp() {
    ...
    private void initMAP() throws Exception {
        ...
        // SSN);
        //this.mapStack = new MAPStackImpl("Simulator", this.sccpStack.getSccpProvider(), SSN_Client);
