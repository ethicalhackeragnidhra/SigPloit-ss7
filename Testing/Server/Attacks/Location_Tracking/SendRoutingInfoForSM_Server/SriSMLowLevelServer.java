...
public abstract class SriSMLowLevelServer implements MAPDialogListener, MAPServiceSmsListener {
    ...
    protected final int SSN_Client = 8; //SMSC SSN
    ...
    protected final String SERVER_NAME = "SMSC02";


    
    protected final ParameterFactoryImpl factory = new ParameterFactoryImpl();

    protected SriSMLowLevelServer() {
        init();
    }
